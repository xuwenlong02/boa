...
macro_rules! make_builtin_fn {
    ($fn:ident, named $name:expr, with length $l:tt, of $p:ident) => {
        let func = crate::builtins::function_object::Function::create_builtin(
            vec![],
            crate::builtins::function_object::FunctionBody::BuiltIn($fn),
        );
...
macro_rules! make_constructor_fn {
    ($body:ident, $global:ident, $proto:ident) => {{
        ...
        let constructor_fn = crate::builtins::function_object::Function::create_builtin(
            vec![],
            crate::builtins::function_object::FunctionBody::BuiltIn($body),
        );
    ...
    ($construct_body:ident, $call_body:ident, $global:ident, $proto:ident) => {{
        ...
        let construct_fn = crate::builtins::function_object::Function::create_builtin(
            vec![],
